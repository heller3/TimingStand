...
def process_file(outfile, x0, y0, chidx, ptkidx):
    ...
    arr_x0, arr_y0 = array('f',[x0]), array('f',[y0])
...
if __name__ == '__main__':
    ...
    # vme_reco_dir = '/Users/ana/mtd/testbeam/data/VME/RECO/v6/'
    ...
    for ib in batch_list:
        for run in ib.grl:
            for infile in [vme_file.replace('RN',str(run)), dt_file.replace('RN',str(run))]:
                ...
                print process_file(outfile, ib.x0, ib.y0, ib.chidx, ib.ptkidx)
